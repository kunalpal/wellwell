      ...
      try {
        if (mode === "plan") {
          ...
          for (const [id, res] of Object.entries(results)) {
            ...
            setLines((l) => [
              ...l,
              `${chalk.cyan(id)}: ${color(res.success ? "ok" : "failed")} ${msg}${err}`,
            ]);
          }
        } else if (mode === "status") {
          ...
          try {
            ...
            console.warn(
              "Failed to load theme colors for status display:",
              error,
            );
          }
          ...
          for (const [id, st] of Object.entries(statuses)) {
            setLines((l) => [
              ...l,
              `${formatStatus(st, false, themeColors)} ${formatModuleId(id)}`,
            ]);
          }
        }
      } finally {
