...
export class TemplateManager {
   ...
   */
  async loadTemplate(modulePath: string, templateName: string): Promise<HandlebarsTemplateDelegate> {
   ...
   */
  async loadAndRender(modulePath: string, templateName: string, context: TemplateContext): Promise<string> {
